...
public class Camion {
    ...
    @Column(name = "cargaActual", nullable = false)
    ...
    @JoinColumn(name = "posicion_final_id")
    private Oficina posicionFinal;
    
    @Column(name = "fecha_llegada_posicion_final")
    private LocalDateTime fechaDeLlegadaPosicionFinal;
    
    @Column(name = "en_ruta", nullable = false)
    private boolean enRuta = false;
    
    @ElementCollection
    @Column(name = "mantenimiento_programado")
    private List<LocalDateTime> mantenimientosProgramados;
    ...
    @Column(name = "regresoAlmacen", nullable = false)
    ...
    public static List<Camion> inicializarCamiones(Oficina lima, Oficina trujillo, Oficina arequipa, Map<Camion,List<LocalDateTime>> mapaMantenimientos) {
        ...
        for (Camion c : camiones) {
            if(mapaMantenimientos.containsKey(c)){
                c.setMantenimientosProgramados(mapaMantenimientos.get(c));
            }
            cap += c.getCapacidad();
        }
//        System.out.println("Capacidad total: " + cap + "\n");
    ...
    public List<LocalDateTime> getMantenimientosProgramados() {
        return mantenimientosProgramados;
    }

    public void setMantenimientosProgramados(List<LocalDateTime> mantenimientosProgramados) {
