...
public class LeerDatos {
    ...
    public static List<Oficina> leerOficinasDesdeArchivo(String filePath) {
        ...
        try (BufferedReader br = new BufferedReader(new FileReader(filePath))) {
            ...
            while ((linea = br.readLine()) != null) {
                ...
                Oficina oficina = getOficina(datos);
                oficinas.add(oficina);
            }
        } catch (IOException e) {
            logger.log(Level.SEVERE, "Error al leer el archivo: " + filePath, e);
        }

        return oficinas;
    }

    private static Oficina getOficina(String[] datos) {
